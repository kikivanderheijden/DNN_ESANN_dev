...
model_l_conv1       = layers.Conv2D(8,(3,3),activation='relu', padding = 'same')(in1) # define first layer and input to the layer
...
model_r_conv1       = layers.Conv2D(8,(3,3),activation='relu', padding = 'same')(in2) # define first layer and input to the layer
...
model_final_conv1       = layers.Conv2D(16,(3,3),activation='relu', padding = 'same')(model_final_merge)
...
# compile
model.compile(loss = cos_dist_2D, optimizer = optimizers.Adam(), metrics=['cosine_proximity','mse',cos_distmet_2D])
# print summary
model.summary()
# save
