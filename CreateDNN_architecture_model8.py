...
model_l_conv1       = layers.Conv2D(8,(1,3),activation='relu', padding = 'same')(in1) # define first layer and input to the layer
...
model_r_conv1       = layers.Conv2D(8,(1,3),activation='relu', padding = 'same')(in2) # define first layer and input to the layer
...
# compile
model.compile(loss = CosineSimilarity(axis=-1), optimizer = optimizers.Adam(), metrics=['cosine_proximity','mse'])
# print summary
model.summary()
# save
