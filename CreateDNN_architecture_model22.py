...
model_l_conv1       = layers.SeparableConv2D(16,(1,3),activation='relu', padding = 'same')(in1) # define first layer and input to the layer
...
model_r_conv1       = layers.SeparableConv2D(16,(1,3),activation='relu', padding = 'same')(in2) # define first layer and input to the layer
...
model_final_conv1       = layers.SeparableConv2D(32,(3,3),activation='relu', padding = 'same')(model_final_merge)
