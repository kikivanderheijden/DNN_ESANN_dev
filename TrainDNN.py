...
dir_model_logger = dir_mofiles+"/model5.h5"
...
# train the model
t.tic()
history = mymodel.fit([an_l_rand_train, an_r_rand_train], labels_rand_train, validation_data=((an_l_rand_test,an_r_rand_test),labels_rand_test), epochs = 15, batch_size = 64, verbose = 1, use_multiprocessing = True, callbacks = [csv_loss_logger, model_logger])
