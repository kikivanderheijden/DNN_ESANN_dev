...
# set directories
dir_anfiles = "/home/jovyan/Data/TESTDNN_small_validationset" # for DSRI
...
np.save(dir_wrfiles+"/an_l_1800_validation.npy",train_an_l_array)
np.save(dir_wrfiles+"/an_r_1800_validation.npy",train_an_r_array)
np.save(dir_wrfiles+"/labels_1800_validation.npy",trainlabels)

import pickle
pickle.dump(filenames, open(dir_wrfiles+'/listfilenames_1800_validation.p','wb'))
