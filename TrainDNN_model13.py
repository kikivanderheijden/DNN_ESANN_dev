...
dir_model_logger    = dir_mofiles+"/"+modelname+"_epoch{epoch:02d}_val-loss_{val_loss:.2f}.h5"
...
# load model
t.tic()
mymodel = load_model(dir_mofiles+"/DNN_"+modelname+".h5",custom_objects={'GlorotUniform': glorot_uniform(), "cos_dist_2D_and_mse": cos_dist_2D_and_mse, "cos_distmet_2D": cos_distmet_2D})
mymodel.summary()
