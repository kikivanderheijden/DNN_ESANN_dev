...
# load model
t.tic()
mymodel = load_model(dir_mofiles+"/DNN_"+modelname+".h5",custom_objects={'GlorotUniform': glorot_uniform(), "cust_mean_squared_error": cust_mean_squared_error, "cos_distmet_2D_angular": cos_distmet_2D_angular})
mymodel.summary()
