...
# load model
model = load_model(dirfiles+'/'+modelname+'_final.h5', custom_objects={"cust_mean_squared_error": cust_mean_squared_error, "cos_dist_2D_and_mse": cos_dist_2D_and_mse, "cos_distmet_2D": cos_distmet_2D})
