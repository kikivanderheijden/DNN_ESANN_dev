...
model_final_merge = layers.Subtract()([model_l_conv1_mp, model_r_conv1_mp]) # does the number of parameters change if you do not make this into a subtraction
...
model_final_flatten = layers.Flatten()(model_final_conv1_mp)
...
model.summary()
model.save(dir_wrfiles+'/DNN_model4.h5') # save model
