...
model_l_conv1       = layers.Conv2D(16,(2,5),activation='relu', padding = 'same')(in1) # define first layer and input to the layer
...
model_r_conv1       = layers.Conv2D(16,(2,5),activation='relu', padding = 'same')(in2) # define first layer and input to the layer
